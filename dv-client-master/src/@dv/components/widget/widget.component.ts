...
export class DvWidgetComponent implements AfterContentInit {
  @HostBinding('class.flipped')
  flipped = false;

  @ContentChildren(DvWidgetToggleDirective, { descendants: true })
  toggleButtons: QueryList<DvWidgetToggleDirective>;
