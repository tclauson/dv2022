...
@Component({
  selector: 'dv-nav-vertical-collapsable',
  templateUrl: './collapsable.component.html',
  styleUrls: ['./collapsable.component.scss'],
  animations: dvAnimations
})
export class DvNavVerticalCollapsableComponent implements OnInit, OnDestroy {
  @Input()
  ...
  ngOnInit(): void {
    ...
    this._dvNavigationService.onItemCollapsed
  ...
  toggleOpen(ev): void {
    ...
    this._dvNavigationService.onItemCollapsed.next(this.item);
    this._dvNavigationService.onItemCollapseToggled.next();
  }
